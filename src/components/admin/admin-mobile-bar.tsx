...
export function AdminMobileBar() {
  ...
  return (
    <header className="flex md:hidden items-center justify-between px-4 h-14 bg-[#2166de] text-white shadow-md shrink-0 sticky top-0 z-40 border-b border-white/10">
      {/* Logo */}
      <Link href="/admin" className="flex items-center gap-2.5 font-bold text-white">
        <div className="bg-white text-[#2166de] p-1.5 rounded-lg shadow-sm shrink-0">
